...
#获取当前路径 [0]是目录[1]是文件名
currPath = os.path.split(os.path.relpath(__file__))[0]
#读取配置文件获取项目路径
...
#保存截图路径
#错误截图
failImagePath = os.path.join(proPath,'retail','report','image','fail','%sfail'%currenTime)
#成功截图
passImagePath = os.path.join(proPath,'retail','report','image','pass','%spass'%currenTime)
